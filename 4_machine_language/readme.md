...
### ROM 각 주소에 명령어가 저장되어 있고, 그걸 쓸 수 있다 정도만 알려준다. 이렇게만 들으면 그게 어떻게 작동하는지는 잘 모르겠다.
### <br/>

### 그런데 생각해보면 간단하다. 
### 컴퓨터의 개발자들이 특정 메모리 주소는 키보드 주소로 약속했다고 하자. 
### 그리고 각 키보드의 버튼에 따라 값은 숫자로 된 어떤 값으로 약속했다고 하자.
### 예를 들어 아스키코드 같은 그런 값들처럼 말이다.
### 키보드에서 1을 눌렀다고 하면, 10진수 49가 키보드 주소로 흘러서 그곳에 값이 저장될 것이다.
#### ![image](https://github.com/user-attachments/assets/f15e39a5-abb6-4e6a-862a-30ce7605c0e6)
### <br/><br/><br/>
